...
export const AVAILABILITY: Availability[] = [
  ...
  av({ modelId: "llama-3.3-70b", providerId: "groq", accessType: "free_tier", status: "available", dailyLimit: 14400, rateLimitRpm: 30, freeQuotaValue: 14400, freeQuotaUnit: "requests", freeQuotaPeriod: "day", apiFormat: "openai", confidence: "verified", sourceUrl: "https://groq.com/pricing", sourceTitle: "Groq Pricing", sourceType: "pricing_page", collectionMode: "frozen" }),
  ...
  av({ modelId: "llama-3.3-70b", providerId: "openrouter", accessType: "free_through_aggregator", status: "available", rateLimitRpm: 20, apiFormat: "openai", confidence: "verified", sourceUrl: "https://openrouter.ai/models/meta-llama/llama-3.3-70b-instruct", sourceTitle: "OpenRouter model page", sourceType: "official_docs", collectionMode: "frozen" }),
  ...
  av({ modelId: "llama-3.1-8b", providerId: "groq", accessType: "free_tier", status: "available", dailyLimit: 14400, rateLimitRpm: 30, apiFormat: "openai", confidence: "verified", sourceUrl: "https://groq.com/pricing", sourceTitle: "Groq Pricing", sourceType: "pricing_page", collectionMode: "frozen" }),
  ...
  av({ modelId: "llama-3.1-8b", providerId: "openrouter", accessType: "free_through_aggregator", status: "available", apiFormat: "openai", confidence: "verified", sourceUrl: "https://openrouter.ai/models", sourceTitle: "OpenRouter models", sourceType: "official_docs", collectionMode: "frozen" }),
  av({ modelId: "llama-3.1-8b", providerId: "cloudflare", accessType: "free_tier", status: "available", dailyLimit: 10000, freeQuotaValue: 10000, freeQuotaUnit: "requests", freeQuotaPeriod: "day", apiFormat: "openai", confidence: "likely", sourceUrl: "https://developers.cloudflare.com/workers-ai", sourceTitle: "Cloudflare Workers AI", sourceType: "official_docs" }),

  av({ modelId: "llama-3.1-70b", providerId: "groq", accessType: "free_tier", status: "available", dailyLimit: 14400, rateLimitRpm: 30, apiFormat: "openai", confidence: "verified", sourceUrl: "https://groq.com/pricing", sourceTitle: "Groq Pricing", sourceType: "pricing_page", collectionMode: "frozen" }),
  ...
  av({ modelId: "llama-3.1-70b", providerId: "openrouter", accessType: "free_through_aggregator", status: "available", apiFormat: "openai", confidence: "verified", sourceUrl: "https://openrouter.ai/models", sourceTitle: "OpenRouter models", sourceType: "official_docs", collectionMode: "frozen" }),

  av({ modelId: "llama-3.2-11b-vision", providerId: "groq", accessType: "free_tier", status: "available", dailyLimit: 14400, rateLimitRpm: 30, apiFormat: "openai", confidence: "verified", sourceUrl: "https://groq.com/pricing", sourceTitle: "Groq Pricing", sourceType: "pricing_page", collectionMode: "frozen" }),
  ...
  av({ modelId: "llama-3.2-90b-vision", providerId: "groq", accessType: "free_tier", status: "available", dailyLimit: 14400, rateLimitRpm: 30, apiFormat: "openai", confidence: "verified", sourceUrl: "https://groq.com/pricing", sourceTitle: "Groq Pricing", sourceType: "pricing_page", collectionMode: "frozen" }),
  av({ modelId: "llama-3.2-90b-vision", providerId: "openrouter", accessType: "free_through_aggregator", status: "available", apiFormat: "openai", confidence: "verified", sourceUrl: "https://openrouter.ai/models", sourceTitle: "OpenRouter models", sourceType: "official_docs", collectionMode: "frozen" }),
  ...
  av({ modelId: "mistral-7b", providerId: "groq", accessType: "free_tier", status: "available", dailyLimit: 14400, rateLimitRpm: 30, apiFormat: "openai", confidence: "verified", sourceUrl: "https://groq.com/pricing", sourceTitle: "Groq Pricing", sourceType: "pricing_page", collectionMode: "frozen" }),
  ...
  av({ modelId: "mistral-small-3", providerId: "groq", accessType: "free_tier", status: "available", dailyLimit: 14400, rateLimitRpm: 30, apiFormat: "openai", confidence: "verified", sourceUrl: "https://groq.com/pricing", sourceTitle: "Groq Pricing", sourceType: "pricing_page", collectionMode: "frozen" }),
  ...
  av({ modelId: "mixtral-8x7b", providerId: "groq", accessType: "free_tier", status: "available", dailyLimit: 14400, rateLimitRpm: 30, apiFormat: "openai", confidence: "verified", sourceUrl: "https://groq.com/pricing", sourceTitle: "Groq Pricing", sourceType: "pricing_page", collectionMode: "frozen" }),
  ...
  av({ modelId: "mixtral-8x7b", providerId: "openrouter", accessType: "free_through_aggregator", status: "available", apiFormat: "openai", confidence: "verified", sourceUrl: "https://openrouter.ai/models", sourceTitle: "OpenRouter models", sourceType: "official_docs", collectionMode: "frozen" }),
  ...
  av({ modelId: "deepseek-chat", providerId: "openrouter", accessType: "free_through_aggregator", status: "available", apiFormat: "openai", confidence: "verified", sourceUrl: "https://openrouter.ai/models/deepseek/deepseek-chat", sourceTitle: "OpenRouter model page", sourceType: "official_docs", collectionMode: "frozen" }),
  ...
  av({ modelId: "deepseek-reasoner", providerId: "openrouter", accessType: "free_through_aggregator", status: "available", apiFormat: "openai", confidence: "verified", sourceUrl: "https://openrouter.ai/models/deepseek/deepseek-r1", sourceTitle: "OpenRouter model page", sourceType: "official_docs", collectionMode: "frozen" }),
  ...
  av({ modelId: "qwen2.5-72b", providerId: "openrouter", accessType: "free_through_aggregator", status: "available", apiFormat: "openai", confidence: "verified", sourceUrl: "https://openrouter.ai/models/qwen/qwen2.5-72b-instruct", sourceTitle: "OpenRouter model page", sourceType: "official_docs", collectionMode: "frozen" }),
  ...
  av({ modelId: "qwen2.5-coder-32b", providerId: "openrouter", accessType: "free_through_aggregator", status: "available", apiFormat: "openai", confidence: "verified", sourceUrl: "https://openrouter.ai/models/qwen/qwen2.5-coder-32b-instruct", sourceTitle: "OpenRouter model page", sourceType: "official_docs", collectionMode: "frozen" }),
  ...
  av({ modelId: "qwen2.5-vl-72b", providerId: "openrouter", accessType: "free_through_aggregator", status: "available", apiFormat: "openai", confidence: "verified", sourceUrl: "https://openrouter.ai/models/qwen/qwen2.5-vl-72b-instruct", sourceTitle: "OpenRouter model page", sourceType: "official_docs", collectionMode: "frozen" }),
  ...
  av({ modelId: "gemma-2-9b", providerId: "groq", accessType: "free_tier", status: "available", dailyLimit: 14400, rateLimitRpm: 30, apiFormat: "openai", confidence: "verified", sourceUrl: "https://groq.com/pricing", sourceTitle: "Groq Pricing", sourceType: "pricing_page", collectionMode: "frozen" }),
  ...
  av({ modelId: "gemma-2-27b", providerId: "groq", accessType: "free_tier", status: "available", dailyLimit: 14400, rateLimitRpm: 30, apiFormat: "openai", confidence: "verified", sourceUrl: "https://groq.com/pricing", sourceTitle: "Groq Pricing", sourceType: "pricing_page", collectionMode: "frozen" }),
